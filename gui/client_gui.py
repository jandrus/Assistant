...
class Client:
    ...
    def gui_loop(self):
        ...
        input_frame = tkinter.Frame(self.win, width=650, height=50, bg=LIGHT_BLUE)
        ...
        self.prev_chat_listbox = tkinter.Listbox(left_frame, width=20, height=26)
        ...
        self.input_area.grid(row=3, column=1, padx=2, pady=5)
        self.input_area.focus()
        send_button = tkinter.Button(input_frame, text="Ask", bg=BUTTON[0], fg=BUTTON[1], command=self.ask)
        send_button.grid(row=3, column=3, padx=2, pady=5)
